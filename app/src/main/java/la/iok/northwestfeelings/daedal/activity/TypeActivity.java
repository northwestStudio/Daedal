...
import la.iok.northwestfeelings.daedal.activity.conversation.ConversationActivity;
import la.iok.northwestfeelings.daedal.activity.createmessage.CreateGroupTextMsgActivity;
import la.iok.northwestfeelings.daedal.activity.createmessage.CreateMessageActivity;
import la.iok.northwestfeelings.daedal.activity.createmessage.CreateSigTextMessageActivity;
import la.iok.northwestfeelings.daedal.activity.createmessage.ShowCustomMessageActivity;
import la.iok.northwestfeelings.daedal.activity.createmessage.ShowDownloadVoiceInfoActivity;
import la.iok.northwestfeelings.daedal.activity.createmessage.ShowMessageActivity;
import la.iok.northwestfeelings.daedal.activity.friend.FriendContactManager;
import la.iok.northwestfeelings.daedal.activity.friend.ShowFriendReasonActivity;
import la.iok.northwestfeelings.daedal.activity.groupinfo.GroupInfoActivity;
import la.iok.northwestfeelings.daedal.activity.imagecontent.ShowDownloadPathActivity;
import la.iok.northwestfeelings.daedal.activity.notify.ShowGroupNotificationActivity;
import la.iok.northwestfeelings.daedal.activity.setting.SettingMainActivity;
import la.iok.northwestfeelings.daedal.activity.setting.ShowLogoutReasonActivity;
import la.iok.northwestfeelings.daedal.activity.showinfo.ShowMyInfoUpdateActivity;
